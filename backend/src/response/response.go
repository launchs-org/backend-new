...
func Error(c *echo.Context, err error) error {
	...
	case *apperrors.StorageQuotaExceededError:
		return c.JSON(http.StatusTooManyRequests, APIResponse{Data: nil, Error: ErrorBody{Code: "STORAGE_QUOTA_EXCEEDED", Message: e.Error()}})
	default:
